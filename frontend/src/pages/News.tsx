...
import { api, News } from '../services/api.ts';
    ...
    <div>
      ...
      <section className="page-banner">
        ...
        <div className="banner-content">
          <h1>News & Blog</h1>
          <p>Stay updated with the latest news, stories, and insights from our community</p>
        </div>
      </section>
            ...
            {recentNews.length > 0 ? (
              ...
              [1, 2, 3, 4, 5, 6].map((item) => (
                <div key={item} className="blog-card">
                  <div className="blog-image">
                    <img src={`/assets/images/news${(item % 2) + 1}.jpg`} alt={`News ${item}`} />
                    <div className="post-category">News</div>
                  </div>
                  <div className="blog-content">
                    <div className="post-meta">
        ...
        <div className="container">
          ...
          <div className="blog-grid">
            {[
              ...
              <div key={index} className="blog-card">
                <div className="blog-image">
                  <img src={`/assets/images/news${(index % 2) + 1}.jpg`} alt={post.title} />
